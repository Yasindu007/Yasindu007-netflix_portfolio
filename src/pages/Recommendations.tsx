      ...
      <div className="recommendation-card">
        ...
        <div className="recommendation-body">
          <p>
            ...
            Malith, who worked for us as a software developer at Kajima from
          ...
          <p>
            During their time with us, MAlith demonstrated strong technical
            ...
            key features of our software <strong>BookingsPlus</strong> and{' '}
            <strong>NHS Open Space</strong>, consistently delivering
            high-quality code while meeting project deadlines. Their ability to
            quickly adapt to new technologies and their proactive approach to
            finding innovative solutions set them apart."
          </p>
          <p>
            💼 "Malith also showed exceptional teamwork and communication
          ...
          <p>
            🌟 "I have no doubt that Malith will be a valuable addition to any
